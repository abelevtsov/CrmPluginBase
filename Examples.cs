...
namespace PluginTests
{
    ...
    /// </summary>
    public class DenyActiveRecordDeletionPlugin : CrmPlugin<Account>, IPlugin
    {
        /// <summary>
        ...
        public override void OnDelete(IPluginExecutionContext context, string entityName, Guid primaryEntityId, Account preEntityImage)
        {
            if (preEntityImage.statuscode == AccountStatus.Активный_Активный)
            {
                throw new CrmException("Active accounts deletion is forbidden!", expected: true);
            }
        }
    }
